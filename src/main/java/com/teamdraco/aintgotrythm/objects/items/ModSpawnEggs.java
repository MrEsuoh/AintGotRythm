package com.teamdraco.aintgotrythm.objects.items;
...
public class ModSpawnEggs extends SpawnEggItem {
    public static final List<ModSpawnEggs> UNADDED_EGGS = new ArrayList<ModSpawnEggs>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public ModSpawnEggs(final NonNullSupplier<? extends EntityType<?>> entityTypeSupplier, final int primaryColour,
    ...
    public ModSpawnEggs(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, final int primaryColor,
